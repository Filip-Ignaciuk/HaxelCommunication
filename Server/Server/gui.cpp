...
void gui::Render() noexcept
{
	...
	ImGui::Begin("Haxel Communication Server", &exit, ImGuiWindowFlags_MenuBar | ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoSavedSettings | ImGuiWindowFlags_NoCollapse);
